...
class  Utils {
 ...
 static DateTime getNextMonth(DateTime date, {int dayOfTheMonth, int monthsToAdd = 1}){
  ...
  static limitarCaracteres(String datos, int cantidadMaxima, [bool ponerPuntosSuspensivos = true]){
    if(datos.length > cantidadMaxima)
      return datos.substring(0, cantidadMaxima)  + "${ponerPuntosSuspensivos ? '...' : ''}";
    return datos;
  }
