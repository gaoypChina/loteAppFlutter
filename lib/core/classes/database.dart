...
class DBSqflite{
  ...
  static Future open() async {
    ...
    const migrationScripts = [
      ...
      ['ALTER TABLE Branches ADD COLUMN cantidadCombinacionesJugadasPermitidasPorTicket INTEGER'],
    ...
    // open the database
     database = await openDatabase(_path, version: migrationScripts.length,
      ...
      await db.execute('CREATE TABLE Settings (id INTEGER PRIMARY KEY, consorcio TEXT, imprimirNombreConsorcio INTEGER, idTipoFormatoTicket INTEGER, descripcionTipoFormatoTicket Text, cancelarTicketWhatsapp INTEGER, imprimirNombreBanca INTEGER, pagarTicketEnCualquierBanca INTEGER, whatsapp TEXT, email TEXT)');
