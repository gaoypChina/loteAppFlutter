...
class MyCheckBox extends StatefulWidget {
  ...
  final bool disable;
  MyCheckBox({Key key, this.title = "", this.titleSideCheckBox = "", this.helperText = "", this.onChanged, this.value = false, this.small = 1, this.medium = 3, this.large = 4, this.xlarge = 5, this.padding = 8, this.isRequired = false, this.color, this.disable = false, this.isSideTitle = false, this.flexOfSideText = 3, this.flexOfSideField = 1.5}) : super(key: key);
  @override
