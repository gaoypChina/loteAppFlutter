...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  _dashboard() async {
    try{
      ...
      listaVentasGrafica = (datos["ventasGrafica"] != null) ? List.from(datos["ventasGrafica"]) : List();
      listaVentasPorLoteria = (datos["loterias"] != null) ? List.from(datos["loterias"]) : List();
  ...
  _dashboardMoneda() async {
    try{
      ...
      listaVentasPorLoteria = (datos["loterias"] != null) ? List.from(datos["loterias"]) : List();
      listaLoteriasJugadasDashboard = (datos["loteriasJugadasDashboard"] != null) ? List.from(datos["loteriasJugadasDashboard"]) : List();
      listaSorteo = (datos["sorteos"] != null) ? List.from(datos["sorteos"]) : null;
      if(listaSorteo != null)
        _cambiarValorListaJugada(listaSorteo[_indexSorteo]["descripcion"]);
  ...
  _cambiarValorListaJugada(String sorteo){
    ...
    List sorteosLoteriasJugadas = (listaLoteriasJugadasDashboard.isNotEmpty) ? List.from(listaLoteriasJugadasDashboard[_indexLoteriaJugadas]["sorteos"]) : null;
